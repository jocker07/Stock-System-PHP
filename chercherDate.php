...
<html>
<head>
<h3><center>Matériels Utilisé Le </center></h3><?php echo $_SESSION['DateChercher']; ?>
<?php 


$orderSql = "SELECT M.image,A.FaeTag,U.username,A.DateSortieMateriel FROM affectation_matériel A JOIN users U ON A.UserId=U.user_id 
JOIN matériel M ON A.FaeTag=M.FaeTag
where strtotime(A.DateSortieMateriel)='2022-08-11'
